...
public class EmployeeDTO {
    ...
    @Email @NotBlank private String personalEmail;
    ...
    @Email @NotBlank private String workEmail;
    private String workPhoneNumber;
    @NotBlank private String gradeLevel;
...
public class EmployeeDTO {
    ...
    /* ─────────── Professional ────────── 
    @NotNull private EmployeeType employeeType;      // must be FULL_TIME, PART_TIME, etc.
    @NotBlank private String employmentStatus;       // ACTIVE, PROBATION, TERMINATED…
    private String jobTitle;
    private LocalDate hireDate;
    private LocalDate terminationDate;
...
public class EmployeeDTO {
    ...
    public String getdesignation() { return designation; }
    public void setdesignation(String designation) { this.lastUpdatedBy = designation; }
